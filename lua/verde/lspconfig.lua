...
local function lsp_keymaps(bufnr)
	...
	-- keymap(bufnr, "n", "gc", "<cmd>lua vim.lsp.buf.declaration()<CR>", opts)
...
M.on_attach = function(client, bufnr)
	lsp_keymaps(bufnr)
	-- TODO: This started failing for some reason???
...
function M.config()
	...
	wk.register({
		...
		["<leader>lh"] = { "<cmd>lua require('verde.lspconfig').toggle_inlay_hints()<cr>", "Hints" },
